    ...
    <section class="slider_section ">
      <div class="container ">
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="img-box">
            <img src="<?php echo get_theme_file_uri('/assets/images/slider-img.png'); ?>" alt="">
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="professional_section layout_padding">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <div class="img-box">
            <img src="<?php echo get_theme_file_uri('/assets/images/professional-img.png') ?>" alt="">
          </div>
        </div>
        <div class="col-md-6 ">
          <div class="detail-box">
    ...
    <div class="container ">
      ...
      <div class="row">
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box ">
            <div class="img-box">
              <img src="<?php echo get_theme_file_uri('/assets/images/s1.png') ?>" alt="" />
            </div>
            <div class="detail-box">
              <h5>
                Maintenance
        ...
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box ">
            <div class="img-box">
              <img src="<?php echo get_theme_file_uri('/assets/images/s2.png') ?>" alt="" />
            </div>
            <div class="detail-box">
              <h5>
                Electrical
        ...
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box ">
            <div class="img-box">
              <img src="<?php echo get_theme_file_uri('/assets/images/s3.png') ?>" alt="" />
            </div>
            <div class="detail-box">
              <h5>
                Plumbing
        ...
        <div class="owl-carousel">
          <div class="item">
            <div class="box">
              <div class="client_id">
                <div class="img-box">
                  <img src="<?php echo get_theme_file_uri('/assets/images/client-1.jpg') ?>" alt="">
                </div>
          ...
          <div class="item">
            <div class="box">
              <div class="client_id">
                <div class="img-box">
                  <img src="<?php echo get_theme_file_uri('/assets/images/client-2.jpg') ?>" alt="">
                </div>
                <div class="client_detail">
                  <div class="client_info">
                    <h6>
